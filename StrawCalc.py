...
#Use print statement to pose the first question
print "If 3 straw make one triangle, how many straws are needed for the whole project?"

#First calculate the number of straws in a side
print 3 * 6, "straws. This is how many straws are needed per side."

#Next take that first equation and multiply it by 14
print (3 * 6) * 14,"straw. This is how many straws are needed for the whole project."
